...
**Course Description:**
  ...
  The course is a hands-on, project-based course that integrates deep mutational profiling (Fowler and Fields, _Nature Methods_, 2014), automated microscopy, and computational biology. The model organism, _Saccharomyces cerevisiae_, will be used as the organismal basis. Our goal is to experimentally determine the fitness of all possible  
