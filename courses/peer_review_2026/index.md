...
Scientific publishing relies heavily on peer review, yet formal training in this skill is rare and often inconsistent across labs. At the same time, preprints are reshaping how research is shared in the life sciences - and conference culture in AI/ML complicates this further, often in exciting ways! This course uses preprint servers such as bioRxiv to teach students how to critically and constructively review manuscripts, with a focus on preprints at the intersection of AI and biology.
...
Students will be paired to serve as "Co-Discussion Leaders" for one BioRxiv/arXiv/ChemRxiv manuscript of their choosing.  The co-discussion leaders will compose one joint written peer review, with a first draft due immediately to us prior to their presentation, reflecting their original thoughts on the manuscript. **We ask that you do not use AI tools in composing, editing, or preparing the review.** For each class, everyone, not just the co-discussion leaders, should be prepared by having read the paper carefully. We will start each day by calling on each participant in the class and asking them to share: 1 confusing thing about the paper and 1 cool thing about the paper.
...
### 5/18
Adam Fillion & Beau Lonnquist - [biorxiv preprint](https://www.biorxiv.org/content/10.64898/2026.04.23.720277v1) - [presentation](http://cdn.fraserlab.com/courses/peer_review_2026/enzyme.pdf)
