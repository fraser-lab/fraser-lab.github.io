...
The document that the iframe inserts is located at `/static/posts/uglymol/uglymol.html`, which can be viewed [in the site repository](https://github.com/fraser-lab/fraser-lab.github.io/tree/master/static/posts/uglymol/uglymol.html).
...
<iframe style="height:500px;width:100%" src="/static/posts/uglymol/uglymol.html#id=3k0n" title="Interactive 3D viewer for PDB entry 3K0N"></iframe>

Further parameters can also be added, such as `#id=3k0n&xyz=10,5,15&eye=90,-30,60&zoom=50`, yielding the following figure:

<iframe style="height:500px;width:100%" src="/static/posts/uglymol/uglymol.html#id=3k0n&xyz=14,18,12&eye=80,71,-41&zoom=50" title="Interactive 3D viewer for PDB entry 3K0N"></iframe>

For a concrete example, the document creating this post can be viewed [as markdown on GitHub](https://github.com/fraser-lab/fraser-lab.github.io/blob/master/_posts/2020-07-08-structures-in-posts.md).
