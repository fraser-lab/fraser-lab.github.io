...
I recently set up a new website for the [Manglik lab](https://mangliklab.com), which is generated by [this Github repository](https://github.com/mangliklab/mangliklab.github.io/).
...
See [this publication announcement](https://mangliklab.com/selective-g-protein-signaling-driven-by-substance-p-neurokinin-receptor-dynamics/) for an example.
...
You'll need to follow the [Topicbox instructions for using your own domain](https://www.topicbox.help/hc/en-us/articles/360053597674-Using-your-own-domain) to use your own domain instead of a topicbox.com domain.
...
If you're a member of the Fraser lab, you can see [an example group meeting page](https://wiki.fraserlab.com/en/group-meeting/2024-01-17).
