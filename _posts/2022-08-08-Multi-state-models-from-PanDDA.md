...
### Option 2
- Use the [extract_ligand-bound_state PyMOL script](https://github.com/gcorrey/scripts/tree/main/extract_ligand-bound_state) to fetch the coordinates using the PDB code and extract the ligand-bound state
...
### Option 1
- Use the [extract_pandda_from_cif script](https://github.com/gcorrey/scripts/tree/main/extract_pandda_from_cif) to extract the PanDDA event map from the deposited structure factor CIFs (discussed in [an earlier post on inspecting PanDDA event maps](https://fraserlab.com/2021/08/26/Inspecting-PanDDA-event-maps/))
