...
<img src="https://raw.githubusercontent.com/gcorrey/scripts/main/extract_pandda_from_cif/cif_schematic.png" alt="Workflow diagram: the structure factor file (xxxx-sf.cif, three data blocks) and coordinates (xxxx.pdb) are downloaded from the Protein Data Bank; extract_pandda.sh, which calls phenix.cif_as_mtz, splits the CIF into xxxx-sf_data.mtz with two data blocks and xxxx-sf_pandda.mtz with one, and both are then viewed with the coordinates in COOT." class="img-fluid" style="max-width: 500px;">
