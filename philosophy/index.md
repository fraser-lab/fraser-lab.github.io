...
{% include carousel.html height="40" unit="%" duration="5" filter="img/carousel/" label="Fraser lab group illustrations over the years" controlposition="90%" indicatorposition="90%" %}
